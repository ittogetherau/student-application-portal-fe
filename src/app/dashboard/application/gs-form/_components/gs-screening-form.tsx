              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-slate-700 dark:text-slate-300">
                  ...
                  <p className="text-slate-600 dark:text-slate-400">
                    You are viewing a completed declaration form. All fields are read-only and cannot be modified.
                  </p>
                </div>
              </div>
            </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormInput
                    ...
                    disabled={readOnly}
                  />
                  <FormInput name="applicantDate" label="Date" type="date" disabled={readOnly} />
                </div>
              </CardContent>
            </Card>
          )}
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormInput
                    ...
                    disabled={readOnly}
                  />
                  <FormInput name="agentDate" label="Date" type="date" disabled={readOnly} />
                </div>
              </CardContent>
            </Card>
          )}
