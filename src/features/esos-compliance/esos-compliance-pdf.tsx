...
const styles = StyleSheet.create({
  ...
  // ── Accounting section — matches document amber palette
  acctSectionTitle: {
    fontSize: 9,
    fontWeight: "bold",
    marginTop: 10,
    ...
    <Document>
      <Page size="A4" style={styles.page} wrap>
        ...
        {/* <Text style={styles.acctInstructionText}>
          ...
          with form support, fill the fields, then save.
        </Text> */}
        <View style={styles.acctTable}>
          ...
          {/* Row: Commission Decision */}
          <View style={styles.acctFieldRow}>
            <View style={styles.acctFieldLabel}>
              <Text>Commission Decision</Text>
            </View>
            <View style={styles.acctFieldValue}>
              <TextInput
                name="acct_commission_decision"
                fontSize={7.5}
                style={styles.acctFieldInput}
              />
            </View>
          ...
          {/* Row: Notes (multiline, last row) */}
          <View style={[styles.acctFieldRow, styles.acctFieldRowLast]}>
            <View style={[styles.acctFieldLabel, { paddingTop: 5 }]}>
              <Text>Accounting Notes</Text>
            </View>
            <View style={styles.acctNotesValue}>
              <TextInput
                name="acct_notes"
                multiline
                fontSize={7.5}
                style={styles.acctNotesInput}
              />
            </View>
          </View>
