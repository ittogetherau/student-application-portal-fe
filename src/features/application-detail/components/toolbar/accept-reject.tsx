...
import { Archive, ChevronsUpDown, XCircle } from "lucide-react";
...
export default function AcceptRejectStatus({
  applicationId,
}: AcceptRejectProps) {
  ...
  const isPending = rejectMutation.isPending || archiveMutation.isPending;
