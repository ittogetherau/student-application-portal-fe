...
export default function AdvancedStandingForm({
  ...
  const watchedValues =
    (useWatch({ control }) as AdvancedStandingFormValues | undefined) ??
    methods.getValues();
    ...
    <FormProvider {...methods}>
      <div className="flex flex-col min-h-0 max-h-full bg-background">
        ...
        <div className="overflow-y-auto bg-muted/5 min-h-0">
          ...
          >
            <form id="advanced-standing-form" onSubmit={handleSubmit(onSubmit)} className="space-y-8 min-w-0">
              ...
              <Card className="border-primary/10 shadow-md">
                ...
                <CardContent className="p-6 pt-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormInput name="studentName" label="Student Full Name" placeholder="Enter Full Name" disabled={true} />
                    <FormInput name="courseName" label="Churchill Course Name" placeholder="Target Course" disabled={true} />
                    ...
                    <div className="md:col-span-2">
                      <FormInput name="email" label="Official Email Address" placeholder="email@example.com" disabled={true} />
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardHeader className="bg-primary/5 border-b border-primary/10">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    {equivalenceFields.length < 7 && (
                      <Button type="button" variant="outline" size="sm" onClick={() => appendEquivalence({ unitCodeAndName: "", ciheEquivalent: "", approved: "" })} className="rounded-full bg-background">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="divide-y px-4 md:px-6">
                    {equivalenceFields.map((field, index) => (
                      <div key={field.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 py-4 items-start group">
        ...
        <DialogContent className="w-[95vw] max-w-5xl h-[90vh] p-0 overflow-auto flex flex-col border-none">
          <DialogHeader className="p-4 border-b bg-card shrink-0">
            ...
            <VisuallyHidden>
              <DialogDescription>
                Preview the advanced standing form with editable PDF fields synced to the form data.
              </DialogDescription>
            </VisuallyHidden>
