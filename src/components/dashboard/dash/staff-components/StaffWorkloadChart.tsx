    ...
    return (
        <Card className="shadow-sm border-slate-200 bg-white h-full flex flex-col">
            <CardHeader className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 pb-8 border-b border-slate-50">
                <div>
                    <CardTitle className="text-lg font-bold text-slate-900 tracking-tight">Staff Workload by Status</CardTitle>
                    <p className="text-xs text-slate-500 font-medium">Individual performance and processing metrics</p>
                </div>
