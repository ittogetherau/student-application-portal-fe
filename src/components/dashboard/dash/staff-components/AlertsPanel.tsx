...
const staffData = [
    { staff: 'J. Smith', underReview: 14, pendingDecision: 8, approved: 9, rejected: 3 },
    { staff: 'M. Jones', underReview: 11, pendingDecision: 6, approved: 12, rejected: 4 },
    { staff: 'K. Brown', underReview: 9, pendingDecision: 7, approved: 10, rejected: 2 },
    { staff: 'A. Davis', underReview: 13, pendingDecision: 5, approved: 8, rejected: 3 },
    { staff: 'R. Wilson', underReview: 10, pendingDecision: 9, approved: 11, rejected: 5 },
];
...
export function AlertsPanel() {
    ...
    return (
        <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm h-full flex flex-col overflow-hidden">
            <div className="p-4 sm:p-6 border-b border-neutral-100 dark:border-neutral-800">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h3 className="text-xl font-medium text-neutral-900 dark:text-neutral-100 tracking-tight">Staff Performance</h3>
                        <p className="text-sm text-neutral-500 dark:text-neutral-400 font-medium mt-1">Applications assigned per officer</p>
                    </div>
                    <div className="flex flex-wrap items-center gap-3 bg-neutral-100 dark:bg-neutral-800 p-1.5 rounded-xl self-start sm:self-auto ring-1 ring-neutral-200 dark:ring-neutral-700">
                        <div className="flex items-center gap-1 pr-2 border-r border-neutral-300 dark:border-neutral-700">
                            ...
                            >
                                ...
                                {staffData.map(s => <option key={s.staff} value={s.staff}>{s.staff}</option>)}
                            </select>
                        </div>
                ...
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={filteredData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                            ...
                            />
                            <Bar dataKey="underReview" stackId="a" fill="#FF7A00" name="Under Review" radius={[0, 0, 0, 0]} />
                            <Bar dataKey="pendingDecision" stackId="a" fill="#FFB800" name="Pending Decision" radius={[0, 0, 0, 0]} />
