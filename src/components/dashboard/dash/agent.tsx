                ...
                <div className="wrapper py-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl sm:text-3xl font-medium text-neutral-900 dark:text-neutral-100 tracking-tight">Agent Portal</h1>
                                <p className="text-sm text-neutral-500 font-medium">Manage your student applications</p>
                            </div>
                        </div>
