...
export function useGSStudentDeclarationQuery(applicationId: string | null) {
  return useQuery<ServiceResponse<GsDeclarationResponse>, Error>({
    ...
    queryFn: async () => {
      if (!applicationId) throw new Error("Application ID is required");
      const response = await gsAssessmentService.getStudentDeclaration(applicationId);
      if (!response.success) {
        throw new Error(response.message);
      }
      return response;
...
export function useGSAgentDeclarationQuery(applicationId: string | null) {
  return useQuery<ServiceResponse<GsDeclarationResponse>, Error>({
    ...
    queryFn: async () => {
      if (!applicationId) throw new Error("Application ID is required");
      const response = await gsAssessmentService.getAgentDeclaration(applicationId);
      if (!response.success) {
        throw new Error(response.message);
      }
      return response;
...
export function useGSStageTwoStatusQuery(applicationId: string | null) {
  return useQuery<ServiceResponse<GsStageTwoStatus>, Error>({
    ...
    queryFn: async () => {
      if (!applicationId) throw new Error("Application ID is required");
      const response = await gsAssessmentService.getStageTwoStatus(applicationId);
      if (!response.success) {
        throw new Error(response.message);
      }
      return response;
...
export function useGSStaffAssessmentQuery(applicationId: string | null) {
  return useQuery<ServiceResponse<StaffAssessmentResponse>, Error>({
    ...
    queryFn: async () => {
      if (!applicationId) throw new Error("Application ID is required");
      const response = await gsAssessmentService.getStaffAssessment(applicationId);
      if (!response.success) {
        throw new Error(response.message);
      }
      return response;
 ...
 */
export function useGSDocumentAutoCompleteMutation(applicationId: string | null) {
  const queryClient = useQueryClient();
  ...
  return useMutation<GsDocumentsResponse, Error, void>({
    ...
    mutationFn: async () => {
      if (!applicationId) throw new Error("Application ID is required");
      const response = await gsAssessmentService.autoCompleteDocuments(applicationId);
      if (!response.success) throw new Error(response.message);
      if (!response.data) throw new Error("Response data is missing");
      return response.data;
    },
 ...
 */
export function useGSStudentDeclarationResendMutation(applicationId: string | null) {
  return useMutation<GsResendDeclarationResponse, Error, GsResendDeclarationRequest | undefined>({
 ...
 */
export function useGSAgentDeclarationSaveMutation(applicationId: string | null) {
  const queryClient = useQueryClient();
 ...
 */
export function useGSAgentDeclarationSubmitMutation(applicationId: string | null) {
  const queryClient = useQueryClient();
...
export function useGSStaffAssessmentSaveMutation(applicationId: string | null) {
  ...
  return useMutation<StaffAssessmentResponse, Error, StaffAssessmentSaveRequest>({
 ...
 */
export function useGSStaffAssessmentSubmitMutation(applicationId: string | null) {
  const queryClient = useQueryClient();

  return useMutation<StaffAssessmentResponse, Error, StaffAssessmentSubmitRequest>({
...
export function useGSStudentDeclarationSaveWithTokenMutation() {
  return useMutation<GsDeclarationResponse, Error, TokenDeclarationMutationParams>({
    mutationFn: async ({ applicationId, token, payload }) => {
      const response = await gsAssessmentService.saveStudentDeclarationWithToken(
        applicationId,
        token,
...
export function useGSStudentDeclarationSubmitWithTokenMutation() {
  return useMutation<GsDeclarationResponse, Error, TokenDeclarationMutationParams>({
    mutationFn: async ({ applicationId, token, payload }) => {
      const response = await gsAssessmentService.submitStudentDeclarationWithToken(
        applicationId,
        token,
