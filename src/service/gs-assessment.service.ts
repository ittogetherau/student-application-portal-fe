import type { GSDocument } from "@/shared/constants/types";
...
class GsAssessmentService extends ApiService {
  ...
  getAssessment = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to fetch GS assessment details");
    }
  };
  ...
  listDocuments = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to fetch GS documents");
    }
  };
  ...
  uploadDocument = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to upload GS document");
    }
  };
  ...
  updateDocumentStatus = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to update GS document status");
    }
  };
  ...
  autoCompleteDocuments = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to auto-complete GS documents");
    }
  };
  ...
  getAgentDeclaration = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to fetch agent declaration");
    }
  };
  ...
  saveAgentDeclaration = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to save agent declaration");
    }
  };
  ...
  submitAgentDeclaration = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to submit agent declaration");
    }
  };
  ...
  getStageTwoStatus = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to fetch stage 2 status");
    }
  };
  ...
  reviewDeclaration = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to review declaration");
    }
  };
  ...
  getStaffAssessment = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to fetch staff assessment");
    }
  };
  ...
  saveStaffAssessment = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to save staff assessment");
    }
  };
  ...
  submitStaffAssessment = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to submit staff assessment");
    }
  };
  ...
  finalizeDecision = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to finalize GS decision");
    }
  };
  ...
  listAssessments = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to list GS assessments", []);
    }
  };
  ...
  getProgress = async (
    ...
    try {
      ...
      return handleApiError(error, "Failed to fetch GS progress");
    }
  };
